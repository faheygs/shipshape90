  ...
  return <SafeAreaView style={styles.safe}>
    ...
    <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      {activeSection === "requests" && isPrivate ? <>
        <View style={styles.sectionHeader}><Text style={styles.eyebrow}>PRIVATE REQUESTS</Text><Text style={styles.sectionTitle}>Choose the roster.</Text><Text style={styles.sectionBody}>People can request access from the locked challenge page. Approving them unlocks the challenge without affecting their current competition.</Text></View>
      ...
      {activeSection === "people" ? <>
        <View style={styles.sectionHeader}><Text style={styles.eyebrow}>PARTICIPANTS</Text><Text style={styles.sectionTitle}>Your roster.</Text><Text style={styles.sectionBody}>{upcoming ? "See everyone committed now and everyone waiting for launch." : "See performance and prize eligibility for everyone in this challenge."}</Text></View>
