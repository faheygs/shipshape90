  ...
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {!isPreview ? <Pressable accessibilityRole="button" accessibilityLabel="Edit profile" onPress={() => router.push("/edit-profile")} style={({ pressed }) => [styles.settingsRow, pressed && styles.historyLinkPressed]}>
        ...
        <Pressable accessibilityRole="button" accessibilityLabel="Open challenge history" onPress={() => router.push("/history")} style={({ pressed }) => [styles.historyLink, pressed && styles.historyLinkPressed]}>
