...
import {
  BADGE_DEFINITIONS,
  HIDDEN_BADGE_DEFINITIONS,
  PUBLIC_BADGE_DEFINITIONS,
} from "@/lib/badges";
...
export default function ProfilePage() {
  ...
  const loadData = useCallback(async () => {
    ...
    // Skip sync_user_badges here — it repopulates user_badges from game data; sync runs on home/history/leaderboard.
  ...
  useSupabaseRealtimeRefresh(supabase, loadData, [
    "daily_logs",
    "profiles",
    "penalty_pot",
    "user_badges",
      ...
      >
        ...
        <div
          className={cn(
            ...
            AVATAR_COLORS.find((c) => c.bg === avatarColor)?.bg ||
              "bg-brand-500",
          )}
        >
          {initials}
      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
          <div className="bg-white/5 rounded-xl p-3 text-center">
            ...
            <p className="text-[9px] text-white/20 mt-1 leading-tight">
              Up to {MAX_TOTAL_POINTS} incl. bonuses
            </p>
          </div>
          <div className="bg-white/5 rounded-xl p-3 text-center">
            ...
            <p className="text-[9px] text-white/20 mt-1 leading-tight">
              {STREAK_BONUS_POINTS} / {STREAK_BONUS_DAYS} perfect days
            </p>
          </div>
          <div className="bg-white/5 rounded-xl p-3 text-center">
          ...
          <div className="bg-white/5 rounded-xl p-3 text-center">
            ...
            <p className="text-[9px] text-white/20 mt-1 leading-tight">
              +{BADGE_COLLECTOR_BONUS_POINTS} if all {BADGE_DEFINITIONS.length}{" "}
              badges earned
            </p>
          </div>
        </div>
        {myPoints != null && myPoints.total_penalty > 0 && (
          <p className="text-[11px] text-white/30 mt-3 text-center">
            Prize pot contributions: $
            {Number(myPoints.total_penalty).toFixed(2)}
          </p>
        )}
      </motion.div>
      ...
      >
        <div className="flex items-center justify-between gap-2 mb-3">
          ...
          <span className="text-[11px] text-white/35 tabular-nums shrink-0">
            {
              BADGE_DEFINITIONS.filter((d) =>
                userBadges.some((b) => b.badge_key === d.id),
              ).length
            }
        ...
        >
          ...
          <div className="flex-1">
            ...
            <span className="text-[11px] text-white/30 block">
              Scoring, tasks, consequences & more
            </span>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="flex-1">
              ...
              <span className="text-[11px] text-white/30 block">
                Exit the competition. Irreversible.
              </span>
            </div>
            <ChevronRight className="w-4 h-4 text-white/20" />
          </button>
      ...
      {profile?.pregnant_bailout && (
        <div className="glass-card p-4 border-pink-500/30 bg-pink-500/5">
          <p className="text-sm text-pink-300 font-medium">
            Pregnancy bailout activated. You&apos;ve exited the competition.
          </p>
        </div>
      )}
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-white/50 text-center">
                This is irreversible. You will forfeit all ability to gain any
                future reward, including winning the prize pot. This is an exit
                — not a pause.
              </p>
