    ...
    <div className="min-h-dvh flex flex-col items-center justify-center px-6 -mt-16">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-display font-bold text-gradient">Join ShipShape90</h1>
          <p className="text-white/50 mt-2 text-sm">90 days. No excuses. Get after it.</p>
        </div>
